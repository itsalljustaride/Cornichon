class PermissionsController < ApplicationController
  ...
  def show
    ...
    @title = "Cornichon - Task Permissions"
  ...
  def new
    ...
    @permission.grouptask_id = params[:grouptask_id]
  ...
  def create
    ...
    respond_to do |format|
      if @permission.save
        format.html { redirect_to(@permission.grouptask, :notice => 'Permissions were successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @permission.update_attributes(params[:permission])
        format.html { redirect_to(@permission.grouptask, :notice => 'Permissions were successfully updated.') }
        format.xml  { head :ok }
      else
